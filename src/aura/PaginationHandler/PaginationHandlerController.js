({
	doInit : function(component, event, helper) {
		//alert(component.get("v.maxLength"));
    ...
    goPage:function(component, event, helpe){
       ...
       // console.log("StartPoint"+component.get("v.startPoint"));
      //  console.log("endPoint"+component.get("v.endPoint"));
        
      /*  var tgl = $A.get("e.Vgnr:PaginationHandler");
     /*  tgl.setParams({
                    "startPointEvt":component.get("v.startPoint"),
           			 "endPointEvt":component.get("v.endPoint")
